...
#ifndef __MashouList_h__
#define __MashouList_h__
...
class MashouList : public AjaxList
{
	Q_OBJECT

public:
	MashouList(MashouView *view = 0, QWidget *parent = 0);
